...
<head>
    ...
    <title><?php echo e($title ?? 'M&A Marketplace'); ?></title>
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        <a href="/" class="<?php echo e(request()->is('/') ? 'border-blue-500 text-slate-900' : 'border-transparent text-slate-500'); ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Marketplace</a>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="/dashboard" class="<?php echo e(request()->is('dashboard*') ? 'border-blue-500 text-slate-900' : 'border-transparent text-slate-500'); ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">Dashboard</a>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <?php if(session('success')): ?>
        <div class="max-w-7xl mx-auto px-4 mt-4 sm:px-6 lg:px-8">
            <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl flex items-center justify-between shadow-sm">
                <span class="text-sm font-medium"><i class="fa fa-check-circle mr-2"></i> <?php echo e(session('success')); ?></span>
    ...
    <?php if(session('error') || $errors->any()): ?>
        <div class="max-w-7xl mx-auto px-4 mt-4 sm:px-6 lg:px-8">
            <div class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-xl flex items-center justify-between shadow-sm">
                <span class="text-sm font-medium"><i class="fa fa-exclamation-circle mr-2"></i> <?php echo e(session('error') ?? $errors->first()); ?></span>
...
</html><?php /**PATH H:\laragon\www\m&a-marketplace-laravel-backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>